      ...
      <div className="mx-auto grid max-w-[1020px] gap-8 sm:grid-cols-3">
        ...
        <div>
          ...
          <div className="mt-3 flex gap-4 text-base">
            ...
            <a href={`mailto:${data.email}`} aria-label={t.email}>
              ✉
            </a>
          </div>
        </div>
  ...
  const groups =
    language === "en"
      ? [
          ...
          ["Other Technologies", "GCP", "BigQuery", "Apps Script"],
        ]
      : [
          ["Front-end", "HTML", "CSS", "JavaScript", "React"],
          ["Back-end", "Java", "Spring Boot", "Node.js", "C#"],
          ["Banco de Dados", "PostgreSQL", "MySQL", "MongoDB"],
          ["Ferramentas", "Docker", "Cloudflare", "Git"],
          ["Outras Tecnologias", "GCP", "BigQuery", "Apps Script"],
        ];
        ...
        <div key={title} className="border border-[#e3e3e3] p-4">
          ...
          <div className="mt-3 flex flex-wrap gap-1">
            {items.map((item) => (
              <span
                key={item}
                className="bg-[#f1f1f1] px-2 py-1 text-[10px] text-[#555]"
              >
                {item}
              </span>
            ))}
